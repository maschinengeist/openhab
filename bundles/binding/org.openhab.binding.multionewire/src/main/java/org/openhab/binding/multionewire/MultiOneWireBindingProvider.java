 ...
 */
package org.openhab.binding.multionewire;
 ...
 * @since 0.6.0
 */
public interface MultiOneWireBindingProvider extends BindingProvider {
	...
	/**
	 * @return the corresponding serverId of the given <code>itemName</code>
	 */
